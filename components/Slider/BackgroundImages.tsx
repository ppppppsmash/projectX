    ...
    <>
      {transitionData && (
        <motion.img
          ...
          className="absolute left-0 top-0 z-10 h-full w-full object-cover brightness-[0.4]"
      ...
      <motion.img
        ...
        className="absolute left-0 top-0 h-full w-full object-cover brightness-[0.4]"
      />
    </>
  );
}
